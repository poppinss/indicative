...
test.group('Sanitizor', () => {
  ...
  test('should sanitize nested values using sanitize method', (assert) => {
    const data = {
      profile: {
        email: 'bar.sneaky@googlemail.com',
      },
  ...
  test('should run multiple sanizations on a given field', (assert) => {
    const data = {
      profile: {
        email: 'bar.sneaky@googlemail.com',
      },
  ...
  test('should pass arguments to sanization methods', (assert) => {
    const data = {
      profile: {
        email: 'bar.sneaky@googlemail.com',
      },
  ...
  test('should be able to sanitize values with array expressions', (assert) => {
    const data = {
      profile: [
        {
          email: 'bar.sneaky@googlemail.com',
  ...
  test('should be able to sanitize values with nested array expressions', (assert) => {
    const data = {
      users: [
        {
          email: 'bar.sneaky@googlemail.com',
  ...
  test('should be able to sanitize values with flat array expressions', (assert) => {
    const data = {
  ...
  test('should return the original data back when there are no matching filters found', (assert) => {
    const data = {
      email: 'bar.sneaky@googlemail.com',
      body: '<p>foo</p>',
    }
  ...
  test('should not mutate the original data set', (assert) => {
    const data = {
      email: 'bar.sneaky@googlemail.com',
      body: '<p>foo</p>',
    }
  ...
  test('should throw an error when sanization rule method is not found', (assert) => {
    const data = {
      profile: {
        email: 'bar.sneaky@googlemail.com',
      },
  ...
  test('sanization should return what\'s received', (assert) => {
    const data = {
      email: 'bar.sneaky@googlemail.com',
    }
  ...
  test('camelcase rules names', (assert) => {
    const data = {
      email: 'bar.sneaky@googlemail.com',
    }
