...
=== Raw
A simple formatter which returns only necessary information about the errors without any localized messages.
Such formatter can be very useful when you want to handle and localize server validation errors on the client-side only.
